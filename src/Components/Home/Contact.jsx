...
const Contact = () => {
    return (
        <div>
            <h1 className="text-3xl mt-5 text-center">You Need Any Help ??</h1>
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
               <img src="https://i.ibb.co/MZw1s0m/contact.png" alt="" />
                <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">New to Blood Donation?</h2>
                <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">We answer the most frequently asked questions in the new Be a Hero Donor Guide. Enter your information to learn the truth about some blood donation myths and how you can help patients.</p>
                <h1>Call Us : 01611149044</h1>
